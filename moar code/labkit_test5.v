...
////////////////////////////////////////////////////////////////////////////
  ...
  defparam reset_sr.INIT = 16'hFFFF;
	...
	wire CD_comp_1_DEBUG;
	wire CD_signal_1_DEBUG;
	wire CD_decoder_1_DEBUG;
	wire CD_comp_2_DEBUG;
	wire CD_signal_2_DEBUG;
	wire CD_decoder_2_DEBUG;
	wire [9:0] comp_dout_DEBUG;
	wire [9:0] demux_out_2_DEBUG;     // Demultiplexer Output
	wire demux_out_ready_2_DEBUG;      // Demultiplexer Output Ready
	wire decoder_init_2_DEBUG;         // Decoder Initialization
	wire [7:0] decoder_dout_2_DEBUG;  // Decoder Data Output
	wire decoder_kout_2_DEBUG;         // Decoder Special Char Output
	wire decoder_dout_ready_2_DEBUG;    // Decoder Output Ready
	...
	PHY_Pair PHY_PAIR_1( 
		...
		.CD_comp_1_DEBUG(CD_comp_1_DEBUG),
		.CD_signal_1_DEBUG(CD_signal_1_DEBUG),
		.CD_decoder_1_DEBUG(CD_decoder_1_DEBUG),
		.CD_comp_2_DEBUG(CD_comp_2_DEBUG),
		.CD_signal_2_DEBUG(CD_signal_2_DEBUG),
		.CD_decoder_2_DEBUG(CD_decoder_2_DEBUG),
		.comp_dout_DEBUG(comp_dout_DEBUG),
		.demux_out_2_DEBUG(demux_out_2_DEBUG),
		.demux_out_ready_2_DEBUG(demux_out_ready_2_DEBUG),
		.decoder_init_2_DEBUG(decoder_init_2_DEBUG),
		.decoder_dout_2_DEBUG(decoder_dout_2_DEBUG),
		.decoder_kout_2_DEBUG(decoder_kout_2_DEBUG),
		.decoder_dout_ready_2_DEBUG(decoder_dout_ready_2_DEBUG)
		);
	...
	wire DLC_RX_addr_1;
	// DEBUG
	wire [5:0] init_state_1_DEBUG;
	wire [5:0] pckt_size_DEBUG;
	wire CRC_E_we_DEBUG;
	wire [10:0] CRC_E_addr_DEBUG;
	wire [7:0] CRC_E_data_DEBUG;
	wire [7:0] MAC_data_DEBUG;
	wire [10:0] MAC_addr_DEBUG;
	wire [2:0] MAC_state_DEBUG;
	wire [4:0] b_state_DEBUG;
	wire [4:0] f_state_DEBUG;
	wire [2:0] s_state_DEBUG;
	wire [3:0] c_state_DEBUG;
	wire b_f_lock_DEBUG;
	wire b_b_lock_DEBUG;
	wire b_c_lock_DEBUG;
	wire f1w_s_lock_DEBUG;
	wire f1w_b_lock_DEBUG;
	wire f1w_c_lock_DEBUG;
	wire f1r_f_lock_DEBUG;
	wire f1r_b_lock_DEBUG;
	wire f2w_f_lock_DEBUG;
	wire f2w_b_lock_DEBUG;
	wire f2w_c_lock_DEBUG;
	wire [4:0] MAC_pckt_num_DEBUG;
	wire MAC_sts_DEBUG;
	wire MAC_cmd_DEBUG;
	wire CRC_sts_DEBUG;
	wire [7:0] CRC_D_TX_DEBUG;
	wire CRC_D_TX_ready_DEBUG;
	wire [4:0] CRC_pckt_num_DEBUG;
	wire CRC_D_RX_ready_DEBUG;
	wire [7:0] CRC_D_RX_DEBUG;
	wire p_DEBUG;
	wire [15:0] dina_DEBUG;
	wire wea_DEBUG;
	wire [7:0] addra_DEBUG;
	wire [15:0] douta_DEBUG;
	wire [4:0] rd_pointer_DEBUG;
	wire [4:0] wr_pointer_DEBUG;
	wire [2:0] CRC_state_DEBUG;
	...
	,// DEBUG
	.init_state_DEBUG(init_state_1_DEBUG)
	);
	...
	,// DEBUG
	.init_state_DEBUG(init_state_2_DEBUG),
	.pckt_size_DEBUG(pckt_size_DEBUG),
	.CRC_E_we_DEBUG(CRC_E_we_DEBUG),
	.CRC_E_addr_DEBUG(CRC_E_addr_DEBUG),
	.CRC_E_data_DEBUG(CRC_E_data_DEBUG),
	.MAC_data_DEBUG(MAC_data_DEBUG),
	.MAC_addr_DEBUG(MAC_addr_DEBUG),
	...
	.MAC_pckt_num_DEBUG(MAC_pckt_num_DEBUG),
	.MAC_sts_DEBUG(MAC_sts_DEBUG),
	.MAC_cmd_DEBUG(MAC_cmd_DEBUG),
	.CRC_sts_DEBUG(CRC_sts_DEBUG),
	.CRC_D_TX_DEBUG(CRC_D_TX_DEBUG),
	.CRC_D_TX_ready_DEBUG(CRC_D_TX_ready_DEBUG),
	.CRC_pckt_num_DEBUG(CRC_pckt_num_DEBUG),
	.CRC_D_RX_ready_DEBUG(CRC_D_RX_ready_DEBUG),
	.CRC_D_RX_DEBUG(CRC_D_RX_DEBUG),
	.p_DEBUG(p_DEBUG),
	...
	assign led[3] = ~F1_empty;
	assign led[4] = ~F2_empty;
...
//	assign analyzer2_data = {p_DEBUG, CRC_sts_DEBUG, douta_DEBUG[15:10], 1'b0, wea_DEBUG, 3'b0, CRC_state_DEBUG};
//	assign analyzer3_data = {1'b0,MAC_sts_DEBUG, MAC_cmd_DEBUG, s_state_DEBUG , wr_pointer_DEBUG, rd_pointer_DEBUG};
...
//	assign analyzer1_data = {CRC_D_TX_DEBUG, CRC_D_RX_DEBUG};
//	assign analyzer2_data = {p_DEBUG, CRC_sts_DEBUG, state, MAC_state_DEBUG, 1'b0, wea_DEBUG, dina_DEBUG[15:10]};
...
////									 f2w_c_lock_DEBUG
////									 };
//	assign analyzer3_data = {1'b0,MAC_sts_DEBUG, MAC_cmd_DEBUG, s_state_DEBUG ,MAC_pckt_num_DEBUG, CRC_pckt_num_DEBUG};
//	assign analyzer4_data = {CRC_D_TX_ready_DEBUG, CRC_D_RX_ready_DEBUG, c_state_DEBUG, f_state_DEBUG, b_state_DEBUG};
