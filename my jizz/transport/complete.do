...
add wave -noupdate -format Literal -radix hexadecimal /complete_tb/uut/oneuserInp
...
add wave -noupdate -format Literal -radix hexadecimal -radixenum symbolic /complete_tb/uut/sendPacketOut
...
add wave -noupdate -format Literal -radix hexadecimal /complete_tb/uut/dafuq
...
WaveRestoreCursors {{Cursor 1} {509103 ps} 0}
...
update
WaveRestoreZoom {473118 ps} {537538 ps}
